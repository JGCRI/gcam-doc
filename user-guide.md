...
QuitFirstFailure | When set to 1, the model will abort a scenario (skip remaining periods, print output, and exit) after the first failed period. This cfeature is not available when running in target finder mode.
