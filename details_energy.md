...
Hydrogen losses and emissions are represented, controlled through exogenous assumptions assigned to technologies of hydrogen liquefaction, transmission, distribution, and storage that have been identified as especially important in the literature (e.g., [Arrigoni and Bravo Diaz 2022](details_energy.html#arrigoni2015)). Hydrogen leaks and losses are important both for the physical energy and capital requirements of a hydrogen system, end user (i.e. delivered) hydrogen prices, and for estimating atmospheric composition and radiative forcing due to the indirect warming potential of hydrogen [Hauglustaine et al. 2022](details_energy.html#hauglustaine2022). Hydrogen gas emissions are estimated in GCAM but are not currently used by Hector to estimate any consequent changes in atmospheric composition and radiative forcing. Specifically, hydrogen transmission and distribution technologies with non-zero leakage are represented with hydrogen input-output coefficients greater than 1; a coefficient of 1.01 indicates 1% leakage of the input hydrogen, for example. The hydrogen emissions coefficient of such a technology, indicated in kg H2 per GJ of hydrogen output, would be estimated as the loss fraction (0.01) divided by the energy content of hydrogen per unit mass (0.1202 GJ of H2 per kg). So, each percent of hydrogen loss corresponds to 0.083 kg of hydrogen gas emissions per GJ of hydrogen delivered to the end user.
...
<a name="arrigoni2015">[Arrigoni and Bravo Diaz 2022]</a> Arrigoni, A., and L. Bravo Diaz, *Hydrogen emissions from a hydrogen economy and their potential global warming impact*, JRC130362, Joint Research Centre, European Commission. [Link](https://publications.jrc.ec.europa.eu/repository/handle/JRC130362)
...
<a name="hauglustaine2022">[Hauglustaine et al. 2022]</a> Hauglustaine, D., F. Paulot, W. Collins, R. Derwent, M. Sand and O. Boucher. 2022. Climate benefit of a future hydrogen economy. *Communications Earth & Environment* 3, 295. [Link](https://doi.org/10.1038/s43247-022-00626-z)
