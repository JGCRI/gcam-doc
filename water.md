...
pcW_t = pcW_{t-1} * (\frac{pcGDP_t}{pcGDP_{t-1}})^{0.37} *
  (\frac{P_t}{P_{t-1}})^{-0.33} * (1 - Tech)
$$

where pcW is per-capita municipal water demand, pcGDP is per-capita GDP, P is price, and Tech stands for autonomous technological change, an exogenous assumption. t and 
