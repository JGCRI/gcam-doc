...
7. [Adding fugitive CO<sub>2</sub> emissions from fossil resources](cmp/368-Adding_fugitive_CO<sub>2</sub>_emissions.pdf)
8. [AgLU data and method updates (connecting land hectares to food calories)](cmp/360-AgLU_data_and_methods.pdf)
9. [GCAM-USA nonCO<sub>2</sub> GHG emissions in industrial and urban processes](cmp/379-GCAM-USA_nonco2_industrial_urban_proc.pdf)
