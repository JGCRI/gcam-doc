...
![Figure 1](gcam-figs/refining.png)
...
![Figure 2](gcam-figs/oil_refining.png)
...
The majority of the world's coal to liquids production is in South Africa, but the technology is available to all regions in GCAM starting in the first future time period. Note that the CO<sub>2</sub> emissions intensity is substantially higher than all other liquid fuel production technologies; where crude oil refining emits about 5 kg of CO<sub>2</sub> per GJ of fuels produced, the emissions factor for coal to liquids is about 130 kg of CO<sub>2</sub> per GJ of fuel produced, which is higher than the emissions from combustion of the fuels produced (about 70 kg CO<sub>2</sub> per GJ). As with biomass liquids, two different production technologies with CCS are represented, with costs and CO<sub>2</sub> removal fractions based on [Dooley (2009)](http://www.sciencedirect.com/science/article/pii/S1876610209008765).
