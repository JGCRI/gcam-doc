...
The original SSP socioeconomic and IAM scenario data used for [CMIP6](http://www.geosci-model-dev.net/9/3461/2016/) were available through the official SSP database. More recent SSP socioeconomic drivers are now available from the [SSP Scenario Explorer](https://data.ece.iiasa.ac.at/ssp), including updated demographic and economic drivers that inform CMIP7-era ScenarioMIP work.
...
To implement the SSPs within earlier GCAM versions, including versions prior to GCAM v7.2, GCAM used the demographic and economic assumptions developed by Lutz et al. (2015) and Dellink et al. (2015), in combination with technology and policy assumptions derived from the SSP narratives (O’Neill et al., 2015). More recent GCAM versions use updated SSP socioeconomic drivers and revised socioeconomic data processing. [CMP-399](cmp/399-SSP_Database2024.pdf) updated GCAM’s SSP socioeconomic inputs from the original 2013 release to the 2024 SSP database release (v3.0.1), including population, GDP, and labor-force projections. [CMP-410](cmp/410-Socioeconomic_Macro_Data_compressed.pdf) further updated the SSP socioeconomic database from v3.0.1 to v3.2 and restructured socioeconomic and macroeconomic data processing, including SSP-specific employment/labor-force differentiation and improved integration between national accounts and external GDP/population inputs.

Table 2 provides a qualitative summary of these parameters; quantitative details are provided in subsequent tables. With the introduction of GCAM-Macro-KLEAM in [CMP-411](cmp/411-GCAM_Macro_KLEAM_incl_Appendix.pdf), labor-market information becomes a more explicit socioeconomic driver in GCAM. In KLEAM, regional labor supply is linked to population and employment assumptions and allocated between agriculture and the Materials sector; the labor market then clears so that labor demand from these sectors is consistent with available labor supply. As a result, Table 2 now includes employment-related socioeconomic inputs. These socioeconomic metrics are generated based on `gcamdata` outputs in [`zsocio_xml_socioeconomics_SSP.R`](https://github.com/JGCRI/gcam-core/blob/master/input/gcamdata/R/zsocio_xml_socioeconomics_SSP.R).
...
| :------------- |:------------- |:------------- |:------------- |:------------- |:------------- |:-------------|:-------------|
| Socioeconomics | Population in 2100 | 8.1 billion | 10.0 billion | 13.1 billion | 0.8 billion / 1.4 billion / 9.8 billion | 8.17 billion | <a href="https://github.com/JGCRI/gcam-core/tree/master/input/gcamdata/inst/extdata/socioeconomics/SSP">Socioeconomics</a> |
|  | Labor force (employment) in 2100 | 2.7 billion | 3.8 billion | 5.5 billion | 0.3 billion / 0.5 billion / 4.1 billion | 2.7 billion | <a href="https://github.com/JGCRI/gcam-core/tree/master/input/gcamdata/inst/extdata/socioeconomics/SSP">Socioeconomics</a> |
|  | GDP (2021) per capita in 2100 | $46,980  | $37,440 | $16,840 | $132,030 / $40,100 / $16,190 | $77,470 | <a href="https://github.com/JGCRI/gcam-core/tree/master/input/gcamdata/inst/extdata/socioeconomics/SSP">Socioeconomics</a> |
...
| | CCS | High | Med | Med | Low / Low / Low | Low | <a href="https://github.com/JGCRI/gcam-core/blob/master/input/gcamdata/R/zenergy_L261.Cstorage.R">CCS extraction costs</a> |
...
| | Industry | Low | Med | Low | High / Med / Low | High | <a href="https://github.com/JGCRI/gcam-core/blob/master/input/gcamdata/R/zenergy_L232.other_industry.R">Industry</a> and <a href="https://github.com/JGCRI/gcam-core/blob/master/input/gcamdata/R/zenergy_L2321.cement.R">Cement </a> |
...
| Pollutant Emissions | Emissions Factors | Low | Med | High | High / High / High | Low | <a href="https://github.com/JGCRI/gcam-core/blob/master/input/gcamdata/R/zemissions_L251.en_ssp_nonco2.R">Emissions</a>|
...
Van Vuuren, D. P., O'Neill, B. C., Tebaldi, C., Sanderson, B. M., Chini, L. P., Friedlingstein, P., ... & Ziehn, T. (2026). The scenario model intercomparison project for CMIP7 (ScenarioMIP-CMIP7). Geoscientific Model Development, 19(7), 2627-2656.
