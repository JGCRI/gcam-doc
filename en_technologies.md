...
{ProfitRate}=\frac{{PriceReceived}-{VariableCost}}{VariableCost}
$$
...
* **share-weight**: share-weight of the [choice function](choice.html). Also used as a switch for technology availability (0 = not available; all other values > 0 = available).
